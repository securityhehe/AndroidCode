package com.octopus.frame.widget.navigation.top;
...
/**
 * @author  zshh create by 2019/4/15
 */
...
public class BottomNavigationViewInner extends BottomNavigationView {
    ...
    public BottomNavigationViewInner(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TintTypedArray a =
                ThemeEnforcement.obtainTintedStyledAttributes(context, attrs, android.support.design.R.styleable.BottomNavigationView,
