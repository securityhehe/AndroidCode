...
/**
 * Created by octopus on 20/04/2017.
 */
public final class RCDiffUtil extends DiffUtil.Callback {

    private List<?> oldData;
    private List<?> newData;
    private Callback diffCallback;

    public RCDiffUtil(List<?> oldData, List<?> newData, Callback diffCallback) {
